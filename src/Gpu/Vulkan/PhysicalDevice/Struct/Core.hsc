...
struct "Vulkan12Features" #{size VkPhysicalDeviceVulkan12Features}
		#{alignment VkPhysicalDeviceVulkan12Features} [
	("sType", ''(), [| const $ pure () |],
		[| \p _ -> #{poke VkPhysicalDeviceVulkan12Features, sType} p
			(#{const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_FEATURES} ::
				#{type VkStructureType}) |]),
	("pNext", ''PtrVoid,
		[| #{peek VkPhysicalDeviceVulkan12Features, pNext} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, pNext} |]),
	("samplerMirrorClampToEdge", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, samplerMirrorClampToEdge} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, samplerMirrorClampToEdge} |]),
	("drawIndirectCount", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, drawIndirectCount} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, drawIndirectCount} |]),
	("storageBuffer8BitAccess", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, storageBuffer8BitAccess} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, storageBuffer8BitAccess} |]),
	("uniformAndStorageBuffer8BitAccess", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, uniformAndStorageBuffer8BitAccess} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, uniformAndStorageBuffer8BitAccess} |]),
	("storagePushConstant8", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, storagePushConstant8} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, storagePushConstant8} |]),
	("shaderBufferInt64Atomics", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderBufferInt64Atomics} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderBufferInt64Atomics} |]),
	("shaderSharedInt64Atomics", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderSharedInt64Atomics} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderSharedInt64Atomics} |]),
	("shaderFloat16", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderFloat16} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderFloat16} |]),
	("shaderInt8", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderInt8} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderInt8} |]),
	("descriptorIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, descriptorIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, descriptorIndexing} |]),
	("shaderInputAttachmentArrayDynamicIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderInputAttachmentArrayDynamicIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderInputAttachmentArrayDynamicIndexing} |]),
	("shaderUniformTexelBufferArrayDynamicIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderUniformTexelBufferArrayDynamicIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderUniformTexelBufferArrayDynamicIndexing} |]),
	("shaderStorageTexelBufferArrayDynamicIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderStorageTexelBufferArrayDynamicIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderStorageTexelBufferArrayDynamicIndexing} |]),
	("shaderUniformBufferArrayNonUniformIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderUniformBufferArrayNonUniformIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderUniformBufferArrayNonUniformIndexing} |]),
	("shaderSampledImageArrayNonUniformIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderSampledImageArrayNonUniformIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderSampledImageArrayNonUniformIndexing} |]),
	("shaderStorageBufferArrayNonUniformIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderStorageBufferArrayNonUniformIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderStorageBufferArrayNonUniformIndexing} |]),
	("shaderStorageImageArrayNonUniformIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderStorageImageArrayNonUniformIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderStorageImageArrayNonUniformIndexing} |]),
	("shaderInputAttachmentArrayNonUniformIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderInputAttachmentArrayNonUniformIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderInputAttachmentArrayNonUniformIndexing} |]),
	("shaderUniformTexelBufferArrayNonUniformIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderUniformTexelBufferArrayNonUniformIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderUniformTexelBufferArrayNonUniformIndexing} |]),
	("shaderStorageTexelBufferArrayNonUniformIndexing", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderStorageTexelBufferArrayNonUniformIndexing} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderStorageTexelBufferArrayNonUniformIndexing} |]),
	("descriptorBindingUniformBufferUpdateAfterBind", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, descriptorBindingUniformBufferUpdateAfterBind} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, descriptorBindingUniformBufferUpdateAfterBind} |]),
	("descriptorBindingSampledImageUpdateAfterBind", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, descriptorBindingSampledImageUpdateAfterBind} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, descriptorBindingSampledImageUpdateAfterBind} |]),
	("descriptorBindingStorageImageUpdateAfterBind", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, descriptorBindingStorageImageUpdateAfterBind} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, descriptorBindingStorageImageUpdateAfterBind} |]),
	("descriptorBindingStorageBufferUpdateAfterBind", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, descriptorBindingStorageBufferUpdateAfterBind} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, descriptorBindingStorageBufferUpdateAfterBind} |]),
	("descriptorBindingUniformTexelBufferUpdateAfterBind", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, descriptorBindingUniformTexelBufferUpdateAfterBind} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, descriptorBindingUniformTexelBufferUpdateAfterBind} |]),
	("descriptorBindingStorageTexelBufferUpdateAfterBind", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, descriptorBindingStorageTexelBufferUpdateAfterBind} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, descriptorBindingStorageTexelBufferUpdateAfterBind} |]),
	("descriptorBindingUpdateUnusedWhilePending", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, descriptorBindingUpdateUnusedWhilePending} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, descriptorBindingUpdateUnusedWhilePending} |]),
	("descriptorBindingPartiallyBound", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, descriptorBindingPartiallyBound} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, descriptorBindingPartiallyBound} |]),
	("descriptorBindingVariableDescriptorCount", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, descriptorBindingVariableDescriptorCount} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, descriptorBindingVariableDescriptorCount} |]),
	("runtimeDescriptorArray", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, runtimeDescriptorArray} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, runtimeDescriptorArray} |]),
	("samplerFilterMinmax", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, samplerFilterMinmax} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, samplerFilterMinmax} |]),
	("scalarBlockLayout", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, scalarBlockLayout} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, scalarBlockLayout} |]),
	("imagelessFramebuffer", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, imagelessFramebuffer} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, imagelessFramebuffer} |]),
	("uniformBufferStandardLayout", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, uniformBufferStandardLayout} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, uniformBufferStandardLayout} |]),
	("shaderSubgroupExtendedTypes", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderSubgroupExtendedTypes} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderSubgroupExtendedTypes} |]),
	("separateDepthStencilLayouts", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, separateDepthStencilLayouts} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, separateDepthStencilLayouts} |]),
	("hostQueryReset", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, hostQueryReset} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, hostQueryReset} |]),
	("timelineSemaphore", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, timelineSemaphore} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, timelineSemaphore} |]),
	("bufferDeviceAddress", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, bufferDeviceAddress} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, bufferDeviceAddress} |]),
	("bufferDeviceAddressCaptureReplay", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, bufferDeviceAddressCaptureReplay} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, bufferDeviceAddressCaptureReplay} |]),
	("bufferDeviceAddressMultiDevice", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, bufferDeviceAddressMultiDevice} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, bufferDeviceAddressMultiDevice} |]),
	("vulkanMemoryModel", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, vulkanMemoryModel} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, vulkanMemoryModel} |]),
	("vulkanMemoryModelDeviceScope", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, vulkanMemoryModelDeviceScope} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, vulkanMemoryModelDeviceScope} |]),
	("vulkanMemoryModelAvailabilityVisibilityChains", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, vulkanMemoryModelAvailabilityVisibilityChains} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, vulkanMemoryModelAvailabilityVisibilityChains} |]),
	("shaderOutputViewportIndex", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderOutputViewportIndex} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderOutputViewportIndex} |]),
	("shaderOutputLayer", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, shaderOutputLayer} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, shaderOutputLayer} |]),
	("subgroupBroadcastDynamicId", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan12Features, subgroupBroadcastDynamicId} |],
		[| #{poke VkPhysicalDeviceVulkan12Features, subgroupBroadcastDynamicId} |]) ]
	[''Show, ''Storable]

struct "Vulkan13Features" #{size VkPhysicalDeviceVulkan13Features}
		#{alignment VkPhysicalDeviceVulkan13Features} [
	("sType", ''(), [| const $ pure () |],
		[| \p _ -> #{poke VkPhysicalDeviceVulkan13Features, sType} p
			(#{const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_FEATURES} ::
				#{type VkStructureType}) |]),
	("pNext", ''PtrVoid,
		[| #{peek VkPhysicalDeviceVulkan13Features, pNext} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, pNext} |]),
	("robustImageAccess", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, robustImageAccess} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, robustImageAccess} |]),
	("inlineUniformBlock", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, inlineUniformBlock} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, inlineUniformBlock} |]),
	("descriptorBindingInlineUniformBlockUpdateAfterBind", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, descriptorBindingInlineUniformBlockUpdateAfterBind} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, descriptorBindingInlineUniformBlockUpdateAfterBind} |]),
	("pipelineCreationCacheControl", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, pipelineCreationCacheControl} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, pipelineCreationCacheControl} |]),
	("privateData", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, privateData} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, privateData} |]),
	("shaderDemoteToHelperInvocation", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, shaderDemoteToHelperInvocation} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, shaderDemoteToHelperInvocation} |]),
	("shaderTerminateInvocation", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, shaderTerminateInvocation} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, shaderTerminateInvocation} |]),
	("subgroupSizeControl", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, subgroupSizeControl} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, subgroupSizeControl} |]),
	("computeFullSubgroups", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, computeFullSubgroups} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, computeFullSubgroups} |]),
	("synchronization2", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, synchronization2} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, synchronization2} |]),
	("textureCompressionASTC_HDR", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, textureCompressionASTC_HDR} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, textureCompressionASTC_HDR} |]),
	("shaderZeroInitializeWorkgroupMemory", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, shaderZeroInitializeWorkgroupMemory} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, shaderZeroInitializeWorkgroupMemory} |]),
	("dynamicRendering", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, dynamicRendering} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, dynamicRendering} |]),
	("shaderIntegerDotProduct", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, shaderIntegerDotProduct} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, shaderIntegerDotProduct} |]),
	("maintenance4", ''#{type VkBool32},
		[| #{peek VkPhysicalDeviceVulkan13Features, maintenance4} |],
		[| #{poke VkPhysicalDeviceVulkan13Features, maintenance4} |]) ]
	[''Show, ''Storable]
